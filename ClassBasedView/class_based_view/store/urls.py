...
from .views import (
  BookCreateView, BookDetailView, BookUpdateView, IndexView, HomeView, BookListView, BookDeleteView, BookFormView, BookRedirectView, delete_picture
)
...
urlpatterns = [
  ...
  path('book_home/', BookFormView.as_view(), name='book_home'),
